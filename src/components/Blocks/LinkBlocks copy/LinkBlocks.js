  ...
  return (
    <section id="blocks" className="container">
      <div className={classes.blocks}>
        <div className={classes.blocks__column}>
          <Block
            title="Merch"
            subtitle="Look good"
          ...
          <Block
            title="Partners"
            subtitle="Our brands"
            desc="Check out our in-house product brands (subsidiaries of Storkies)."
            size="lg"
            img={images.partners}
            subfolder="sets"
            hoverCount={hoverCount}
        ...
        <div className={`${classes.blocks__column} ${classes.column_2}`}>
          <Block
            title="About us"
            subtitle="Learn more"
